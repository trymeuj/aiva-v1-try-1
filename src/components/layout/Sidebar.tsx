...
export default function Sidebar() {
  ...
  return (
    <div className="relative">
      {/* Desktop Sidebar */}
      <nav id="layout" className="hidden lg:flex flex-col w-64 h-screen bg-white border-r border-gray-200">
        <div className="px-6 py-4">
          <h1 className="text-xl font-bold text-gray-800">AI Agent Creator</h1>
        </div>
